          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-gray-50 p-4 rounded-lg">
            ...
            <div>
              ...
              <div className="flex flex-row space-x-2 mt-1">
                <span className="text-gray-700">{pickupLocation || "Not selected"}</span>
                <span className="text-gray-700">{pickupTime || "Not selected"}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-row space-x-2 mt-1">
                <span className="text-gray-700">{dropoffLocation || "Not selected"}</span>
                <span className="text-gray-700">{dropoffTime || "Not selected"}</span>
              </div>
            </div>
          </div>
        </div>
