...
const login = () => {
  ...
  return (
    <>
{session ? (
  <div className="w-full max-w-lg p-8 mx-auto mt-10 bg-white rounded-lg shadow-lg">
    <div className="text-center mb-6">
      <p className="p-3">Welcome {session.user?.name}</p>
    ...
    <div className="bg-gray-100 p-6 rounded-lg mb-6">
      ...
      <p className="text-gray-700">
        <strong>Date:</strong> {formatDate(dropoffDate)}
      </p>
      <p className="text-gray-700">
        <strong>Location:</strong> {dropoffLocation}
      </p>
      <p className="text-gray-700">
        <strong>Time:</strong> {dropoffTime}
      </p>
    </div>
    ...
    <div className="text-center mt-6">
      <Link href={'/confirm'}>
      <button
        className="inline-block px-6 py-3 mb-4 font-semibold text-white bg-green-600 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-300 transition"
      >
        Confirm Booking
      </button>
      </Link>
        ...
        <div>
          <div className="relative py-3 sm:max-w-xl sm:mx-auto">
            <div className="relative px-2 py-2 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
            ...
            />
                ...
                <div className="flex justify-center w-full items-center">
                  <div>
                    <button
                      ...
                      className="flex items-center justify-center py-2 px-2 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        height="25"
                ...
                <div className="mt-5">
                  <button
                    className="py-2 px-4 bg-gradient-to-r from-gray-700 to-black hover:bg-gradient-to-r hover:from-gray-600 hover:to-black transition duration-300 ease-out text-white w-full text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                    type="submit"
                  >
                    Log in
                  </button>
